...
public final class ActivityMain10Binding implements ViewBinding {
  ...
  private ActivityMain10Binding(@NonNull ConstraintLayout rootView, @NonNull ImageView num) {
  ...
  public static ActivityMain10Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.num;
      ImageView num = ViewBindings.findChildViewById(rootView, id);
      if (num == null) {
        break missingId;
      }

      return new ActivityMain10Binding((ConstraintLayout) rootView, num);
    }
