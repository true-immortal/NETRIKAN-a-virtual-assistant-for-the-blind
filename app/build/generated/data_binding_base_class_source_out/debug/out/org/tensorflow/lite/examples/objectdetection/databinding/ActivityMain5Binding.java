...
public final class ActivityMain5Binding implements ViewBinding {
  ...
  private ActivityMain5Binding(@NonNull LinearLayout rootView, @NonNull ImageView inputImageBtn) {
  ...
  public static ActivityMain5Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain5Binding((LinearLayout) rootView, inputImageBtn);
    }
